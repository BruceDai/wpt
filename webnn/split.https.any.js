...
const testSplit = async (inputShape, inputValue, expectedArray, splits, axis = undefined) => {
...
promise_test(async () => {
  ...
  await testSplit(
    ...
    3);
}, 'test split with a number splits and default axis options');
...
promise_test(async () => {
  ...
  await testSplit(
    ...
    [1, 1, 1]);
}, 'test split with an array splits and default axis options');
