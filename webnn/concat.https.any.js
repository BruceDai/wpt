...
ExecuteArray.forEach(executeType => {
  ...
  DeviceTypeArray.forEach(deviceType => {
    ...
    }, `test concat two 1D tensors / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat three 1D tensors / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat four 1D tensors / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat five 1D tensors / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat two 2D tensors with axis=0 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat three 2D tensors with axis=0 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat four 2D tensors with axis=0 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat five 2D tensors with axis=0 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat two 2D tensors with axis=1 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat three 2D tensors with axis=1 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat four 2D tensors with axis=1 / ${deviceType} / ${executeType}`);
    ...
    promise_test(async () => {
      ...
      await testConcat(isSync, tensors, expected);
    }, `test concat five 2D tensors with axis=1 / ${deviceType} / ${executeType}`);
    ...
    }, `test concat two 3D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat three 3D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat four 3D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat five 3D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat two 4D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat three 4D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat four 4D tensors / ${deviceType} / ${executeType}`);
    ...
    }, `test concat five 4D tensors / ${deviceType} / ${executeType}`);
  });
});