...
const testConcat = async (tensors, expected) => {
  const inputs = [];
  const namedInputs = {};
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat two 2D tensors with axis=0');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat three 2D tensors with axis=0');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat four 2D tensors with axis=0');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat five 2D tensors with axis=0');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat two 2D tensors with axis=1');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat three 2D tensors with axis=1');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat four 2D tensors with axis=1');
...
promise_test(async () => {
  ...
  await testConcat(tensors, expected);
}, 'test concat five 2D tensors with axis=1');
